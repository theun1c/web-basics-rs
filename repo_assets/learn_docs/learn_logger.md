...
В нем я вижу несколько недочетов. следует сделать функцию log приватной и вместо консольного вывода следует создать вывод в файл. Также стоит изменить вывод времени в нужном мне формате. 